    ...
    <Grid container spacing={1}>
      <Grid item xs={12}>
        <div className={classes.frameImage}>
          <img src={`${getImageUrl('/the-family_u5px3q.png')}`} alt="frameImage" />
        </div>
      </Grid>
      <Grid item xs={12} sm={3}>
        <Grid container spacing={1}>
          <Grid item xs={12}>
            ...
            <div style={{ height: WindowMode === 'window' ? widthScale * 10 + 70 : widthScale * 20 + 148 }}>
              <ImageUploader
      ...
      <Grid item xs={12} sm={6}>
        ...
        <div style={{ height: widthScale * 20 + 148 }}>
          <ImageUploader
      ...
      <Grid item xs={12} sm={3}>
        <Grid container spacing={1}>
          ...
          <Grid item xs={12}>
            ...
            <div style={{ height: WindowMode === 'window' ? widthScale * 10 + 70 : widthScale * 20 + 148 }}>
              <ImageUploader
                imageFilename={wallArtID == '' || !WallArtData ? '' : WallArtData.images[4].name}
                successfullySaved={successfullySaved}
                setUploadedFlag={setUploadedFlag}
                currentImageNo={4}
                currentWallArtID={currentWallArtID}
